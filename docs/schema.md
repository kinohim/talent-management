...
| nearest_station_line | VARCHAR(100) | NULL可 | 自由記述。例：JR山手線 |
| nearest_station_name | VARCHAR(100) | NULL可 | 自由記述。例：渋谷駅 |
...
| nearest_station_line | VARCHAR(100) | NULL可 | 自由記述。例：JR山手線。employeeテーブルと同じ形（HeartRails Express APIの3段階プルダウンで選択） |
| nearest_station_name | VARCHAR(100) | NULL可 | 自由記述。例：渋谷駅。同上 |
