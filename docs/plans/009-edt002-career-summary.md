# 009 EDT002 経歴概要・自己PR登録(AI生成含む)

## 目的

経歴概要・自己PRをREF004[表紙]タブのセクションとして編集できるようにし、登録済みデータからのAI文章生成(Gemini/Claude選択式)を提供する(docs/screens.md EDT002)。
...
- `components/career-summary/AiGeneratePanel.tsx`: AI生成パネル
  ...
  - データ不足時の案内、エラー種別ごとの文言表示(docs/screens.md EDT002)
